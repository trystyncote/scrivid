...
@pytest_parametrize(
    ...
    assemble_arguments(
        ...
        (motion_tree.VideoInstructions, "body"),
...
@pytest_parametrize("node_cls,method", [
    ...
    (motion_tree.VideoInstructions, "convert_to_string"),
])
...
@pytest_parametrize(
    ...
    assemble_arguments(
        (empty, 
         [motion_tree.VideoInstructions, motion_tree.Start, motion_tree.HideImage, motion_tree.Continue,
          motion_tree.MoveImage, motion_tree.InvokePrevious, motion_tree.End]),
        (figure_eight,
         [motion_tree.VideoInstructions, motion_tree.Start, motion_tree.Continue, motion_tree.MoveImage,
